...
namespace bitzhuwei.PatternFormat {
    partial class MiniDFAEdgeDraft {
        public void ToMermaid(TextWriter w, MiniDFAInfo MiniDFAInfo) {
            this.from.PrintId(w);
            ...
            if (MiniDFAInfo != null) {
                if (MiniDFAInfo.edgeTokenScriptDict.TryGetValue(this, out var tokenScripts)) {
