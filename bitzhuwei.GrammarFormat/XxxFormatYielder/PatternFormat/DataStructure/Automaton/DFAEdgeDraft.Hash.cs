...
namespace bitzhuwei.PatternFormat {
    partial class DFAEdgeDraft : IComparable<DFAEdgeDraft> {
        // 指明此cache需要更新才能用。
        // faster comparing.
        private bool dirty = true;

        public static bool operator ==(DFAEdgeDraft left, DFAEdgeDraft right) {
        ...
        public int CompareTo(DFAEdgeDraft other) {
