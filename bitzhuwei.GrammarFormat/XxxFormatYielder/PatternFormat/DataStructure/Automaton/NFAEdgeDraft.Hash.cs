...
namespace bitzhuwei.PatternFormat {
    partial class NFAEdgeDraft : IComparable<NFAEdgeDraft> {
        // 指明此cache需要更新才能用。
        // faster comparing.
        private bool dirty = true;

        public static bool operator ==(NFAEdgeDraft left, NFAEdgeDraft right) {
        ...
        public int CompareTo(NFAEdgeDraft other) {
