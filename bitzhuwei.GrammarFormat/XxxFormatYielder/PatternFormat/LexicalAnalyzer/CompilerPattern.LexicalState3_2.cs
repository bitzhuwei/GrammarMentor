...
namespace bitzhuwei.PatternFormat
{
    partial class CompilerPattern
    {
        ...
        /// <para>oh! reverse</para>
        /// </summary>
        private static readonly LexicalState lexicalState3_2 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[3_2]",
            new LexicalRule(
            ...
            context =>
            {
                ...
                context.result.errorDict.Add(token, new TokenErrorInfo(token, $"Missing reversed content]"));
