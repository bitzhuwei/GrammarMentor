...
namespace bitzhuwei.GrammarFormat {
    // SLR(1)项：VnRegulation + 圆点的位置
    /// <summary>
    /// <see cref="VnRegulationDraft"/> with position of the dot.
    /// </summary>
    public partial class SLR1Item {
        private static Dictionary<VnRegulationDraft, Dictionary<int, SLR1Item>> objDict = new Dictionary<VnRegulationDraft, Dictionary<int, SLR1Item>>();
        /// <summary>
        ...
        /// <returns></returns>
        public static SLR1Item GetItem(VnRegulationDraft regulation, int dotPosition) {
            SLR1Item result;
            if (objDict.TryGetValue(regulation, out var dict2)) {
                if (dict2.TryGetValue(dotPosition, out result)) {
                    ...
                    result = new SLR1Item(regulation, dotPosition);
                    dict2.Add(dotPosition, result);
                }
            }
            else {
                result = new SLR1Item(regulation, dotPosition);
                dict2 = new Dictionary<int, SLR1Item>();
                dict2.Add(dotPosition, result);
        ...
        /// <param name="regulation"></param>
        /// <param name="dotPosition"></param>
        private SLR1Item(VnRegulationDraft regulation, int dotPosition) {
