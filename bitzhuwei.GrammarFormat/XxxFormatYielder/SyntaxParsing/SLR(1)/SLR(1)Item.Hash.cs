...
namespace bitzhuwei.GrammarFormat {
    partial class SLR1Item : IComparable<SLR1Item> {
        // 指明此cache需要更新才能用。
        // faster comparing.
        private bool dirty = true;

        public static bool operator ==(SLR1Item left, SLR1Item right) {
        ...
        public int CompareTo(SLR1Item other) {
