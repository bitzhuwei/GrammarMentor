...
namespace bitzhuwei.GrammarFormat {
    partial class LR0State : IComparable<LR0State> {
        // 指明此cache需要更新才能用。
        // faster comparing.
        private bool dirty = true;

        public static bool operator ==(LR0State left, LR0State right) {
        ...
        public int CompareTo(LR0State other) {
