...
namespace bitzhuwei.GrammarFormat {
    partial class CompilerGrammar {
        private static readonly LexicalState lexicalState3_1 = new LexicalState($"{nameof(CompilerGrammar)}.LexiStates[3_1]",
            new LexicalRule(
            ...
            context => {
                ...
                context.result.errorDict.Add(token, new TokenErrorInfo(token, $"Missing content for Vt."));
