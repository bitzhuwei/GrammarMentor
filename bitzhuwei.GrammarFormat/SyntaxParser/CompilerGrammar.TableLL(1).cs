    ...
    partial class CompilerGrammar {
        ...
        private static void InitializeSyntaxStates() {
            ...
            { // table[3]
                ...
                line.Add(EType.Vn, regulations[5]);/*Actions[7]*/
                line.Add(EType.Vn, regulations[6]);/*Actions[8]*/
                line.Add(EType.Vt, regulations[5]);/*Actions[9]*/
                line.Add(EType.Vt, regulations[6]);/*Actions[10]*/
                line.Add(EType.empty, regulations[5]);/*Actions[11]*/
                line.Add(EType.empty, regulations[6]);/*Actions[12]*/
            ...
            { // table[4]
                ...
                line.Add(EType.Vn, regulations[8]);/*Actions[14]*/
                line.Add(EType.Vt, regulations[7]);/*Actions[15]*/
                line.Add(EType.Vt, regulations[8]);/*Actions[16]*/
                line.Add(EType.empty, regulations[7]);/*Actions[17]*/
                line.Add(EType.empty, regulations[8]);/*Actions[18]*/
                table.Add(EType.Candidate, line);
            }
            { // table[5]
                var line = new Dictionary<string, Regulation>();
                line.Add(EType.Vn, regulations[9]);/*Actions[19]*/
                line.Add(EType.Vt, regulations[10]);/*Actions[20]*/
                line.Add(EType.empty, regulations[11]);/*Actions[21]*/
                table.Add(EType.V, line);
            }
            { // table[6]
                var line = new Dictionary<string, Regulation>();
                line.Add(EType.Vt, regulations[12]);/*Actions[22]*/
