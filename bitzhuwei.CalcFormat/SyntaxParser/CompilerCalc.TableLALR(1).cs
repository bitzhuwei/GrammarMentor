...
namespace bitzhuwei.CalcFormat {
    partial class CompilerCalc {
        ...
        private static void InitializeSyntaxStates() {
            ...
            list[4].actionDict.Add(EType.Multiplicative, new LRGotoAction(syntaxStates[2]));/*Actions[19]*/
            list[4].actionDict.Add(EType.Primary, new LRGotoAction(syntaxStates[3]));/*Actions[20]*/
            list[4].actionDict.Add(EType.LeftParenthesis, new LRShiftInAction(syntaxStates[4]));/*Actions[21]*/
            list[4].actionDict.Add(EType.number, new LRShiftInAction(syntaxStates[5]));/*Actions[22]*/
            // list[5]
            ...
            // list[6]
            list[6].actionDict.Add(EType.Multiplicative, new LRGotoAction(syntaxStates[11]));/*Actions[28]*/
            ...
            // list[7]
            list[7].actionDict.Add(EType.Multiplicative, new LRGotoAction(syntaxStates[12]));/*Actions[32]*/
            ...
            // list[8]
            list[8].actionDict.Add(EType.Primary, new LRGotoAction(syntaxStates[13]));/*Actions[36]*/
            ...
            // list[9]
            list[9].actionDict.Add(EType.Primary, new LRGotoAction(syntaxStates[14]));/*Actions[39]*/
            ...
            // list[10]
            list[10].actionDict.Add(EType.RightParenthesis, new LRShiftInAction(syntaxStates[15]));/*Actions[42]*/
            list[10].actionDict.Add(EType.Plus, new LRShiftInAction(syntaxStates[6]));/*Actions[43]*/
            list[10].actionDict.Add(EType.Dash, new LRShiftInAction(syntaxStates[7]));/*Actions[44]*/
            // list[11]
            list[11].actionDict.Add(EType.Asterisk, new LRShiftInAction(syntaxStates[8]));/*Actions[45]*/
            list[11].actionDict.Add(EType.Slash, new LRShiftInAction(syntaxStates[9]));/*Actions[46]*/
            list[11].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[0]));/*Actions[47]*/
            ...
            // list[12]
            list[12].actionDict.Add(EType.Asterisk, new LRShiftInAction(syntaxStates[8]));/*Actions[50]*/
            list[12].actionDict.Add(EType.Slash, new LRShiftInAction(syntaxStates[9]));/*Actions[51]*/
            list[12].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[1]));/*Actions[52]*/
            list[12].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[1]));/*Actions[53]*/
            list[12].actionDict.Add(EType.Dash, new LRReducitonAction(regulations[1]));/*Actions[54]*/
            // list[13]
            list[13].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[3]));/*Actions[55]*/
            list[13].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[3]));/*Actions[56]*/
            list[13].actionDict.Add(EType.Dash, new LRReducitonAction(regulations[3]));/*Actions[57]*/
            list[13].actionDict.Add(EType.Asterisk, new LRReducitonAction(regulations[3]));/*Actions[58]*/
            list[13].actionDict.Add(EType.Slash, new LRReducitonAction(regulations[3]));/*Actions[59]*/
            // list[14]
            list[14].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[4]));/*Actions[60]*/
            list[14].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[4]));/*Actions[61]*/
            list[14].actionDict.Add(EType.Dash, new LRReducitonAction(regulations[4]));/*Actions[62]*/
            list[14].actionDict.Add(EType.Asterisk, new LRReducitonAction(regulations[4]));/*Actions[63]*/
            list[14].actionDict.Add(EType.Slash, new LRReducitonAction(regulations[4]));/*Actions[64]*/
            // list[15]
            list[15].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[6]));/*Actions[65]*/
            list[15].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[6]));/*Actions[66]*/
            list[15].actionDict.Add(EType.Dash, new LRReducitonAction(regulations[6]));/*Actions[67]*/
            list[15].actionDict.Add(EType.Asterisk, new LRReducitonAction(regulations[6]));/*Actions[68]*/
            list[15].actionDict.Add(EType.Slash, new LRReducitonAction(regulations[6]));/*Actions[69]*/
