...
namespace bitzhuwei.StepFormat
{
    ...
    {
        private static readonly LexicalState lexicalState4_4 = new LexicalState($"{nameof(CompilerStep)}.LexiStates[4_4]",
            new LexicalRule(
            ...
            context =>
            {
                ...
                context.result.errorDict.Add(token, new TokenErrorInfo(token, "Missing numbers or [A-Z_] ."));
