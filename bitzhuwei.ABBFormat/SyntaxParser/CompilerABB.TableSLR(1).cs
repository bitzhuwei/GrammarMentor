...
namespace bitzhuwei.ABBFormat
{
    partial class CompilerABB
    {
        ...
        private static void InitializeSyntaxStates()
        {
            ...
            // list[4]
            list[4].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[0]));/*Actions[8]*/
            list[4].actionDict.Add(EType.EndOfTokenList, new LRReducitonAction(regulations[0]));/*Actions[9]*/
            // list[5]
            list[5].actionDict.Add(EType.Plus, new LRReducitonAction(regulations[2]));/*Actions[10]*/
