...
namespace bitzhuwei.PatternFormat {
    partial class CompilerPattern {
        private static readonly LexicalState lexicalState161 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[161]",
            new LexicalRule(
            ...
            context => lexicalState256),
            new LexicalRule(
            currentChar => currentChar == 'r'/*'\u0072'(114)*/,
            context => lexicalState257),
            new LexicalRule(
