...
namespace bitzhuwei.PatternFormat {
    partial class CompilerPattern {
        private static readonly LexicalState lexicalState354 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[354]",
            new LexicalRule(
