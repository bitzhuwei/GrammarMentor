...
namespace bitzhuwei.PatternFormat {
    partial class CompilerPattern {
        private static readonly LexicalState lexicalState258 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[258]",
            new LexicalRule(
