...
namespace bitzhuwei.PatternFormat {
    partial class CompilerPattern {
        private static readonly LexicalState lexicalState223 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[223]",
            new LexicalRule(
