...
namespace bitzhuwei.PatternFormat {
    partial class CompilerPattern {
        private static readonly LexicalState lexicalState36 = new LexicalState($"{nameof(CompilerPattern)}.LexicalStates[36]",
            new LexicalRule(
