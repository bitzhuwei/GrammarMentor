...
namespace bitzhuwei.PostfixFormat {
    partial class CompilerPostfix {
        private static readonly LexicalState lexicalState0 = new LexicalState($"{nameof(CompilerPostfix)}.LexicalStates[0]",
            new LexicalRule(
            currentChar => '0'/*'\u0030'(48)*/ <= currentChar && currentChar <= '9'/*'\u0039'(57)*/,
            context => {
                BeginToken(context, EType.@entityId, EType.@refEntity);
                ExtendToken(context);
