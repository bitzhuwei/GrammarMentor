...
namespace bitzhuwei.Ints2Format {
    partial class CompilerInts2 {
        ...
        private static void InitializeSyntaxStates() {
            ...
            // list[2]
            list[2].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[1]));/*Actions[5]*/
            list[2].actionDict.Add(EType.@Comma, new LRReducitonAction(regulations[1]));/*Actions[6]*/
            // list[3]
            list[3].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[2]));/*Actions[7]*/
            list[3].actionDict.Add(EType.@Comma, new LRReducitonAction(regulations[2]));/*Actions[8]*/
            // list[4]
            list[4].actionDict.Add(EType.Int, new LRGotoAction(syntaxStates[5]));/*Actions[9]*/
            list[4].actionDict.Add(EType.@integer, new LRShiftInAction(syntaxStates[3]));/*Actions[10]*/
            // list[5]
            list[5].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[0]));/*Actions[11]*/
            list[5].actionDict.Add(EType.@Comma, new LRReducitonAction(regulations[0]));/*Actions[12]*/
