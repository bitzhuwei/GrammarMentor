...
namespace bitzhuwei.NumbersFormat {
    partial class CompilerNumbers {
        ...
        private static void InitializeSyntaxStates() {
            ...
            // list[2]
            list[2].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[1]));/*Actions[8]*/
            list[2].actionDict.Add(EType.@float, new LRReducitonAction(regulations[1]));/*Actions[9]*/
            list[2].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[1]));/*Actions[10]*/
            // list[3]
            list[3].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[2]));/*Actions[11]*/
            list[3].actionDict.Add(EType.@float, new LRReducitonAction(regulations[2]));/*Actions[12]*/
            list[3].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[2]));/*Actions[13]*/
            // list[4]
            list[4].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[3]));/*Actions[14]*/
            list[4].actionDict.Add(EType.@float, new LRReducitonAction(regulations[3]));/*Actions[15]*/
            list[4].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[3]));/*Actions[16]*/
            // list[5]
            list[5].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[0]));/*Actions[17]*/
            list[5].actionDict.Add(EType.@float, new LRReducitonAction(regulations[0]));/*Actions[18]*/
            list[5].actionDict.Add(EType.@EndOfTokenList, new LRReducitonAction(regulations[0]));/*Actions[19]*/
