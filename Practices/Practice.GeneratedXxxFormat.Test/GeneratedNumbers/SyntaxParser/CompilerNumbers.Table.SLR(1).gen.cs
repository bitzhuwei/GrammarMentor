...
namespace bitzhuwei.NumbersFormat {
    partial class CompilerNumbers {
        ...
        private static void InitializeSyntaxStates() {
            ...
            // list[4]
            list[4].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[3]));/*Actions[13]*/
            list[4].actionDict.Add(EType.@float, new LRReducitonAction(regulations[3]));/*Actions[14]*/
            // list[5]
            list[5].actionDict.Add(EType.@integer, new LRReducitonAction(regulations[0]));/*Actions[15]*/
            list[5].actionDict.Add(EType.@float, new LRReducitonAction(regulations[0]));/*Actions[16]*/
