...
namespace bitzhuwei.NumbersFormat {
    partial class CompilerNumbers {
        private static readonly LexicalState lexicalState0 = new LexicalState($"{nameof(CompilerNumbers)}.LexicalStates[0]",
            new LexicalRule(
            currentChar => '0'/*'\u0030'(48)*/ <= currentChar && currentChar <= '9'/*'\u0039'(57)*/,
            context => {
                BeginToken(context, EType.@integer, EType.@float);
                ExtendToken(context);
